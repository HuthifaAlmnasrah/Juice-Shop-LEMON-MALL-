...
public class GreenFruitsActivity extends AppCompatActivity {
    ...
    private void showDialog() {
        ...
        account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(GreenFruitsActivity.this, AccountActivity.class));
            }
        });
        basket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(GreenFruitsActivity.this, BasketActivity.class));
            }
        });
        orders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(GreenFruitsActivity.this, OrdersActivity.class));
            }
        });
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(GreenFruitsActivity.this, LoginActivity.class));
                finish();
            }
        });
        dialog.show();
