...
public class NewFruitsActivity extends AppCompatActivity {
    ...
    private void showDialog() {
        ...
        account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(NewFruitsActivity.this, AccountActivity.class));
            }
        });
        basket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(NewFruitsActivity.this, BasketActivity.class));
            }
        });
        orders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(NewFruitsActivity.this, OrdersActivity.class));
            }
        });
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewFruitsActivity.this, LoginActivity.class));
                finish();
            }
        });
        dialog.show();
