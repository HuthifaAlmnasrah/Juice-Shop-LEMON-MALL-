...
public class BasketActivity extends AppCompatActivity {
    ...
    private ImageView back, menu, orderNowIc;
    private TextView title, orderNowTxt;
    ...
    private void initViews() {
        ...
        orderNowIc = findViewById(R.id.order_now);
        orderNowIc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BasketActivity.this, HomeActivity.class));
            }
        });
        orderNowTxt = findViewById(R.id.order_now_txt);
        orderNowTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BasketActivity.this, HomeActivity.class));
            }
    ...
    private void showDialog() {
        ...
        account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(BasketActivity.this, AccountActivity.class));
            }
        });
        ...
        orders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                startActivity(new Intent(BasketActivity.this, OrdersActivity.class));
            }
        });
